...
#define sis3104_set_lemo_out1 (1<<4)
#define sis3104_set_lemo_out2 (1<<5)
#define sis3104_set_lemo_out3 (1<<6)
...
#define sis3104_clear_lemo_out1 (1<<20)
#define sis3104_clear_lemo_out2 (1<<21)
#define sis3104_clear_lemo_out3 (1<<22)
...
public:
    ...
    virtual int setOutput3(bool);

    virtual int readOutput1();
    ...
    int readA32BLT32FIFO(const uint32_t addr, uint32_t* dma_buffer, uint32_t request_nof_words, uint32_t* got_nof_words);
